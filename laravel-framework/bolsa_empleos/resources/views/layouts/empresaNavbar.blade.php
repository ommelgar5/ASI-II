...
<nav class="navbar navbar-expand-lg navbar-light bg-light justify-content-between">
  ...
  <div href="#" class="dropdown mr-2">
    ...
    <a href="#"></a>
    <img src="/storage/public/empresas_logo/{{ Auth::guard('empresa')->user()->logo }}" alt="{{ Auth::guard('empresa')->user()->logo }}" width="50" class="rounded-circle dropdown-toggle" data-toggle="dropdown" aria-expanded="true" style="border: 1px solid steelblue;">
