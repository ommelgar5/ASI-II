...
@extends('layouts.adminUser')
    ...
    @section('content')
        ...
        {!!Form::model($programaSolic,['route'=>['editHabilidad.update',$programaSolic->cod_progr_solic],'method'=>'PUT'])!!}

            <label class="text-muted"> Programa: </label>
            <select class="form-control" name="cod_programa">
                @foreach($programas as $programa)
                    @if($programaSolic->cod_progr_solic == $programa->cod_programa)
            ...
            <select class="form-control" name="cod_nivel">
                @foreach($niveles as $nivel)
                    @if($programaSolic->cod_progr_solic == $nivel->cod_nivel)
            ...
            <div class="text-center mb-5">
                ...
                <a href="/editHabilidad"  class="btn btn-default">Cancelar</a>
            </div>
