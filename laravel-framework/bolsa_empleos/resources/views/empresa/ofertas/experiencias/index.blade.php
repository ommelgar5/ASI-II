            ...
            <div class="panel panel-primary mb-2 text- mb-3">
                <div class="panel-heading py-1" >
                    <div class="row p-0">
                        ...
                        <a href="/editExperiencia/{{ $experiencia->id }}/edit" style="color: white;" class="col-xs-1 text-center"><i class="fa fa-pencil-square fa-2x" aria-hidden="true"></i></a>
                        {!!Form::open(['route'=>['editExperiencia.destroy',$experiencia->id],'method'=>'DELETE','class'=>'text-center col-xs-2 p-0'])!!}
