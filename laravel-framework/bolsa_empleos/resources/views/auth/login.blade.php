                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal form-simple error" method="POST" action="{{ route('login') }}" novalidate="">
                                                ...
                                                <fieldset class="form-group position-relative has-icon-left mb-0 error">
                                                    <input type="text" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }} form-control-lg input-lg" id="email" name="dui" type="email" placeholder="Correo" value="{{ old('email') }}" required="" autofocus aria-invalid="true">
