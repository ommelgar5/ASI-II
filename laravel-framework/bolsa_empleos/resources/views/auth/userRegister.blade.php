                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control required dui-inputmask" id="DUI" name="DUI" pattern="[0-9]{8}-[0-9]" placeholder="00000000-0" minlength="10" maxlength="10">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
...
<script type="text/javascript">
    $(document).ready(function(){
      ...
      // DUI
      $('.dui-inputmask').inputmask("99999999-9");
